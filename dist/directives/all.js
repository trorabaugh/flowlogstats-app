  ...
  return {
    ...
    execute: function () {
      ...
      angular.module('grafana.directives').directive("rtEndpointHealthDashboard", function () {
        return {
          templateUrl: 'public/plugins/flowlogstats-app/directives/partials/endpointHealthDashboard.html',
          scope: {
            ctrl: "=",
            endpoint: "="
          }
      ...
      angular.module('grafana.directives').directive("rtCheckHealth", function ($compile, datasourceSrv, timeSrv) {
        return {
          templateUrl: 'public/plugins/flowlogstats-app/directives/partials/checkHealth.html',
          scope: {
            model: "="
          },
      ...
      angular.module('grafana.directives').directive("rtEndpointHealth", function () {
        return {
          templateUrl: 'public/plugins/flowlogstats-app/directives/partials/endpointHealth.html',
          scope: {
            endpoint: "=",
            ctrl: "="
          }
      ...
      angular.module('grafana.directives').directive('endpointCollectorSelect', function ($compile, $window, $timeout) {
        return {
          ...
          templateUrl: 'public/plugins/flowlogstats-app/directives/partials/endpointCollectorSelect.html',
